...
class Day25
  ...
  def self.part1(row, column)
    # where the first number ios 20151125 and each subsequent number is generated by
    # multiplying by 252533 and taking the remainder of the division by 33,554,393
    #
    # The ordinal at row 1 column is the nth triangle number (n)(n+1)/2
    # row 3010, column 3019 ends at the 3010+3019-1st column or 6028th column
    # The ordinal for that cell is 6027*6028/2+3010 = 18,168,388th cell
    # So we only need to multiply by 252533 18,168,387 times
